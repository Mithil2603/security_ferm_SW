...
CREATE TABLE IF NOT EXISTS clients (
    ...
    timeline_unit VARCHAR(20) NOT NULL DEFAULT 'months',
    timeline_duration INT NOT NULL DEFAULT 1,
    rate_per_day DOUBLE NOT NULL DEFAULT 0,
    total_timeline_amount DOUBLE NOT NULL DEFAULT 0,
    addon_days INT NOT NULL DEFAULT 0,
    guard_categories JSON,
...
CREATE TABLE IF NOT EXISTS invoices (
    ...
    bank_account_id INT,
    particular VARCHAR(255) DEFAULT 'Security Guard',
    rate_per_day DOUBLE DEFAULT 0,
    monthly_rate DOUBLE DEFAULT 0,
    guards_count INT DEFAULT 1,
    hsn_code VARCHAR(50) DEFAULT '998525',
    total_duty_days INT,
    bill_items JSON,
    notes TEXT,
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
