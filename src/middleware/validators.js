...
const createClientSchema = Joi.object({
  ...
  employee_count: Joi.number().integer().min(1).optional().allow('', null).default(1).label('Employee count'),
  timeline_unit: Joi.string().valid('months', 'days').optional().allow('', null).default('months').label('Timeline unit'),
  timeline_duration: Joi.number().integer().min(1).optional().allow('', null).default(1).label('Timeline duration'),
  rate_per_day: Joi.number().min(0).optional().allow('', null).label('Rate per day'),
  total_timeline_amount: Joi.number().min(0).optional().allow('', null).label('Total timeline amount'),
  addon_days: Joi.number().integer().min(0).optional().allow('', null).default(0).label('Add on days'),
  guard_categories: Joi.any().optional().allow('', null).label('Guard categories'),
...
const updateClientSchema = Joi.object({
  ...
  employee_count: Joi.number().integer().min(1).optional().allow('', null).label('Employee count'),
  timeline_unit: Joi.string().valid('months', 'days').optional().allow('', null).label('Timeline unit'),
  timeline_duration: Joi.number().integer().min(1).optional().allow('', null).label('Timeline duration'),
  rate_per_day: Joi.number().min(0).optional().allow('', null).label('Rate per day'),
  total_timeline_amount: Joi.number().min(0).optional().allow('', null).label('Total timeline amount'),
  addon_days: Joi.number().integer().min(0).optional().allow('', null).label('Add on days'),
  guard_categories: Joi.any().optional().allow('', null).label('Guard categories'),
...
const createInvoiceSchema = Joi.object({
  ...
  absent_guard_days: Joi.number().min(0).optional().allow(null, '').label('Absent guard days'),
  absence_deduction: Joi.number().min(0).optional().allow(null, '').label('Absence deduction'),
  invoice_number: Joi.string().max(50).optional().allow('', null).label('Invoice number'),
  site_name: Joi.string().max(255).optional().allow('', null).label('Site name'),
  bank_account_id: Joi.number().integer().positive().optional().allow('', null).label('Bank account'),
  particular: Joi.string().max(255).optional().allow('', null).label('Particular'),
  rate_per_day: Joi.number().min(0).optional().allow('', null).label('Rate per day'),
  monthly_rate: Joi.number().min(0).optional().allow('', null).label('Monthly rate'),
  total_duty_days: Joi.number().integer().min(0).optional().allow('', null).label('Total duty days'),
